...
echo "   Scrapegoat:   REDIS_URL, DATABASE_URL, CHIMERA_BRAIN_HTTP_URL or CHIMERA_BRAIN_ADDRESS, CHIMERA_STATION_TIMEOUT=90"
echo "   Chimera Core: REDIS_URL (same as Scrapegoat), CHIMERA_BRAIN_ADDRESS, BRAINSCRAPER_URL (for telemetry)"
echo "   One-time people-search alignment: ./scripts/railway-people-search-align.sh"
echo ""
echo "Done. See V2_PILOT_RAILWAY_ALIGNMENT.md and PEOPLE_SEARCH_CHECKLIST.md."
